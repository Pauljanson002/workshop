...
import os
train_ds = ImageNet1000(data_path="/ibex/ai/reference/CV/ILSVR/classification-localization/data/jpeg/", train=True, download=True,)
test_ds = ImageNet1000(data_path="/ibex/ai/reference/CV/ILSVR/classification-localization/data/jpeg/", train=False, download=True,)
